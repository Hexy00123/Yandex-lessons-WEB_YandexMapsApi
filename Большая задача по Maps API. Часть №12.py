    ...
    def clickOnMap(self, a0):
        if a0.button() == Qt.LeftButton:
            ...
            if req.status_code == 200:
                ...
                req2 = requests.request(method='GET',
                                        url='https://search-maps.yandex.ru/v1/',
                                        params={
                                            'll': ','.join([str(self.ll[0] + l_x), str(self.ll[1] - l_y)]),
                                            'spn': '0.00045045045,0.00045045045',
                                            ...
                                            'results': '1'})
                try:
                    organization = req2.json()['features'][0]['properties']['name']
                except IndexError:
