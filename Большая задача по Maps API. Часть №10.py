...
class Window(QtWidgets.QWidget):
    ...
    def initUI(self):
        ...
        self.label.setGeometry(0, 500, 300, 50)
    ...
    def search(self):
        ...
        if self.line_edit.text():
            ...
            if response.status_code == 200:
                ...
                if self.is_index.isChecked():
                    index = \
                        result['metaDataProperty']['GeocoderMetaData']['AddressDetails']['Country'][
                ...
                self.label.setText(f'Адрес: {addres}' + index)
